...
model_param_list = [(SIRNE, dict(r = 0.2, mu = 0.2, rho = 0.2, epsilon = 0.0001, timesteps = 10)),
...
def test_model(model, model_params):
    model_obj = model(poisson_calc_g, poisson_calc_g1, poisson_calc_g2, probability_lambda = 3)
